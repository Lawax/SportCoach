...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText mmain_regismail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mmain_regisname_input = findViewById(R.id.activity_main_appName_input);
        ...
        mmain_regismail.setText(getIntent().getExtras().getString("data"));
